...
import { ColumnDefinition } from '../../api/ColumnDefinition';
import { ColumnNGprime } from '../../api/columnNGprime';
import { Table, TableModule } from 'primeng/table';

@Component({
  selector: 'app-table-practices-ngprime',
  templateUrl: './table-practices-ngprime.component.html',
  styleUrls: ['./table-practices-ngprime.component.scss'],
})
export class TablePracticesNgprimeComponent {
